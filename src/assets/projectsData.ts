const projects = [
  ...
  {title: "Portfolio Website", 
    ...
    Another goal of mine is to include an 'about me' page, which provides visitors with a more holistic picture of me as a person, via my hobbies and interests, past experience, and other related skillsets.

    Another goal of mine is to integrate MongoDB into my website, allowing visitors to comment below my projects and leave constructive feedback on anything related to my work, enabling me to become a better developer. This is currently a work in progress.
